...
return new class extends Migration
{
    ...
    {
        Schema::create('docente_detsolicitudes', function (Blueprint $table) {
          $table->id(); // ID auto-incremental como clave primaria
          // Llave foránea a 'solicitudes'
          // Borrado en cascada
          $table->unsignedBigInteger('id_solicitud');
          $table->foreign('id_solicitud')->references('id')->on('docente_solicitudes')->onDelete('cascade');
    ...
    {
      Schema::dropIfExists('docente_detsolicitudes');
    }
};
